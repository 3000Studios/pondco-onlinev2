  ...
  return (
    ...
    >
      ...
      <div className="flex-1 relative w-full overflow-hidden">
        ...
        <main 
          id="main-content" 
          className="relative z-10 w-full max-w-7xl mx-auto p-4 pb-32 md:pb-8 md:p-6 lg:p-8 outline-none min-h-full"
          tabIndex={-1}
          role="main"
        >
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className={`p-4 rounded border shadow-xs flex items-center justify-between ${
                ...
                <div>
                  <div className="text-xs font-bold font-mono text-slate-700 uppercase">LEDE RECORDS INDEXED</div>
              ...
              <div className={`p-4 rounded border shadow-xs flex items-center justify-between ${
                ...
                <div>
                  <div className="text-xs font-bold font-mono text-slate-700 uppercase">SECURITY ESCALATIONS</div>
              ...
              <div className={`p-4 rounded border shadow-xs flex items-center justify-between ${
                ...
                <div>
                  <div className="text-xs font-bold font-mono text-slate-700 uppercase">CITIZEN SUBMISSIONS</div>
              ...
              <div className={`p-4 rounded border shadow-xs flex items-center justify-between ${
                ...
                <div>
                  <div className="text-xs font-bold font-mono text-slate-700 uppercase">ACCESSIBILITY CERTIFICATION</div>
